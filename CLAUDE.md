...
- Each item in a report must include an **Assessment** and **Recommendations**. Use a clear heading for each item, then indent the assessment and recommendations as sub-bullets. Example format:
  ```
  ### Item Title
